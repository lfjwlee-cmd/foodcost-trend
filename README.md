...
매일 아침(KST) 자동으로 전날 올라온 한국 음식·신메뉴 유튜브 콘텐츠를 모아
벤토그리드 HTML 리포트로 발행합니다. 보통 06:00~07:30 사이에 올라오며, 정확한 분은
보장하지 않습니다 — GitHub 무료 스케줄러가 매번 1~3시간 늦게 시작하기 때문입니다
(실측: 설정 06:30 → 실행 08:10~08:29, 설정 04:20 → 실행 07:33). 크론을 더 앞당겨도
해결되지 않아, 시각 보장 대신 "아침 중"으로 합의한 상태입니다.
